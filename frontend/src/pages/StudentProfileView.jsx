...
export default function StudentProfileView() {
  ...
  return (
    <StudentLayout title={t('studentProfile')}>
      <div className="max-w-2xl mx-auto space-y-6 pb-12">
        ...
        {/* App Preferences */}
        <div className="bg-white dark:bg-slate-900 rounded-2xl p-6 shadow-sm border border-slate-200 dark:border-slate-800 space-y-4">
          <h3 className="text-sm font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-2">
            {t('appPreferences')}
          </h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {/* Theme Preferences */}
            <div className="p-4 bg-slate-50 dark:bg-slate-800 rounded-2xl border border-slate-100 dark:border-slate-800 flex flex-col gap-3">
                ...
                <button
                  ...
                  className={`flex-1 py-2 px-3 rounded-xl font-bold text-xs flex items-center justify-center gap-1.5 transition-all ${
                    theme === 'light'
                      ...
                      : 'bg-white dark:bg-slate-900 hover:bg-slate-100 text-slate-650 dark:text-slate-300 border border-slate-200 dark:border-slate-800'
                  }`}
                >
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {profile.enrolled_courses.map((course) => (
                <div
                  key={course._id}
                  className="flex items-center gap-3 p-3.5 bg-slate-50 dark:bg-slate-800 rounded-xl border border-slate-100 dark:border-slate-800"
                >
