            ...
            <form onSubmit={handleEnrollStudent} className="space-y-4 mt-4">
              ...
              <div className="flex items-center justify-end gap-2 pt-2">
                <button
                  type="button"
                  onClick={() => setIsEnrollModalOpen(false)}
                  className="px-4 py-2 border border-slate-205 dark:border-slate-800 text-slate-650 dark:text-slate-400 font-extrabold text-xs rounded-xl hover:bg-slate-50 dark:hover:bg-slate-850"
                  disabled={enrollLoading}
                >
                  Cancel
                </button>
